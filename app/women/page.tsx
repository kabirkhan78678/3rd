...
export default function WomenPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (activeCategory !== "All") {
      let matchKey = activeCategory.toLowerCase();
      if (activeCategory === "Skirts & Shorts") {
        matchKey = "shorts";
      }
      list = list.filter((p) => p.subcategory.toLowerCase() === matchKey || p.subcategory.includes(matchKey));
    }
    ...
    return list;
  }, [allWomen, activeCategory, activeSize, activePrice, sort]);
